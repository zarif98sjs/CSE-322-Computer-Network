...
//            if(CHUNK % 10000 == 0) System.out.println("Chunk #"+CHUNK);
    ...
    public void recieveFile(String fileName, String fileType,int filesize,DataInputStream dataInputStream,int CHUNK_SIZE,String fileId) throws IOException {

        int bytes = 0;
        FileOutputStream fileOutputStream = new FileOutputStream("src/client/"+fileType+"_"+fileId+"_"+fileName);
                ...
                while (true) {
                    ...
                    try {
                        ...
                        else if(tokens.elementAt(0).equals("file"))
                        {
                            ...
                            recieveFile(fileName,fileType,filesize,disFile,CHUNK_SIZE,fileID);
