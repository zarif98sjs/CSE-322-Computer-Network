...
#ifndef ES_RED_QUEUE_DISC_H
#define ES_RED_QUEUE_DISC_H
...
struct EZombie
{
  ...
  EZombie(int32_t flowID, int32_t count)
  {
    this->flowID = flowID;
    this->count = count;
  }
 ...
 */
class ESRedQueueDisc : public QueueDisc
{
public:
  /**
  ...
  /**
   * \brief ESRedQueueDisc Constructor
   *
